...
const HelpTooltip = props => {
	...
	return <Tooltip text={text} placement='top-start' delay={300} style={{ maxWidth: '250px' }}>
		<svg className='helpTooltip' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 640 640'>
